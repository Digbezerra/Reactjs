...
function AccountOperations() {
  ...
  const { loan, loanPurpose, balance } = useSelector((state) => state.account);
  ...
  function handleRequestLoan() {
    if (!currentLoanAmount || !currentLoanPurpose) return;
    dispatch(requestLoan(currentLoanAmount, currentLoanPurpose));
